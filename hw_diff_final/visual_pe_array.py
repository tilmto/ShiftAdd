...
path1 = 'trajectory/pe_array1.json'
path2 = 'trajectory/pe_array2.json'
path3 = 'trajectory/pe_array3.json'
path4 = 'trajectory/pe_array4.json'
path5 = 'trajectory/pe_array5.json'
...
plt.title('EDP - Dataflow', fontsize=font_big)
plt.ylabel('EDP', fontsize=font_mid)
plt.xlabel('Dataflow Type', fontsize=font_mid)
...
plt.savefig('pe_array.png', bbox_inches='tight')
plt.show()
